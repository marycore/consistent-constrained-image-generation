...
#Run your script.
python -m src.run --images-dir /users/sbsh670/data/ccig-generated-images/gpt-image-2-low/clevr_1_scenes_UNSAT --prompts-file /users/sbsh670/data/ccig_evalData/clevr_1_scenes_UNSAT.jsonl --method clipscore --domain clevr --out-dir /users/sbsh670/data/ccig-generated-images/gpt-image-2-low/clevr_1_scenes_UNSAT --clip-checkpoint /users/sbsh670/Long-CLIP/checkpoints/longclip-L.pt 
...
@dataclass
class GPTImage1Runner(Runner):
    model_id: str = "gpt_image_1"
    ...
    def run(
        ...
        *,
        ...
        if not api_key:
            raise RuntimeError("OPENAI_API_KEY is not set. Required for gpt_image_1 inference.")
    ...
    def run_finetuned(
        ...
        *,
        ...
        raise NotImplementedError("run_finetuned is not supported for gpt_image_1 (closed API).")


runner = GPTImage1Runner()
register(runner)
